...
""" 
Start → plank/top position
elbow_angle ≈ 160-180°
stage = None
reps = 0

🔽 Going DOWN (lowering chest)
↓ go down
elbow_angle decreases (170 → 140 → 110 → 80)

when:
elbow_angle < 90 (DOWN_THRESHOLD)

→ stage = "down"

🔼 Going UP (pushing up)
↓ push up
elbow_angle increases (80 → 110 → 140 → 170)

when:
elbow_angle > 160 (UP_THRESHOLD)
AND stage == "down"
